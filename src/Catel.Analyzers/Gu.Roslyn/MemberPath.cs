...
#pragma warning restore CA1034 // Nested types should not be visible
    {
        ...
        /// </summary>
        public IReadOnlyList<SyntaxToken> Tokens => tokens;
        ...
        public bool TryFirst(out SyntaxToken token) => tokens.TryFirst(out token);
        ...
        /// <param name="token">The <see cref="SyntaxToken"/>.</param>
        /// <returns>True if found.</returns>
        public bool TrySingle(out SyntaxToken token) => tokens.TrySingle(out token);
        ...
        /// <param name="token">The <see cref="SyntaxToken"/>.</param>
        /// <returns>True if found.</returns>
        public bool TryLast(out SyntaxToken token) => tokens.TryLast(out token);
        ...
        public bool StartsWith(PathWalker other)
        {
            ...
            {
                if (tokens[i].ValueText != other.tokens[i].ValueText)
                {
                    return false;
                }
            }
