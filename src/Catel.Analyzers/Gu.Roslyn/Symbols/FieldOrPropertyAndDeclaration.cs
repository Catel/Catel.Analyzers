...
#pragma warning restore RS0016 // Add public types and members to the declared API
{
    ...
    public FieldOrPropertyAndDeclaration(IFieldSymbol field, FieldDeclarationSyntax declaration)
    {
        ...
        FieldOrProperty = new FieldOrProperty(field);
    ...
    public FieldOrPropertyAndDeclaration(IPropertySymbol property, PropertyDeclarationSyntax declaration)
    {
        ...
        FieldOrProperty = new FieldOrProperty(property);
        Declaration = declaration ?? throw new ArgumentNullException(nameof(declaration));
    }
    ...
    {
        return FieldOrProperty.Equals(other.FieldOrProperty);
    }

    /// <inheritdoc/>
    public override bool Equals(object? obj)
    {
        return obj is FieldOrPropertyAndDeclaration other && Equals(other);
    }

    /// <inheritdoc/>
    public override int GetHashCode()
    {
        return FieldOrProperty.GetHashCode();
    }
}
