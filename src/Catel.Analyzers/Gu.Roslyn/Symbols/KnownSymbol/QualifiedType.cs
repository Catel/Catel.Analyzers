...
#pragma warning restore GU0025 // Seal type with overridden equality.
{
    ...
    protected QualifiedType(string fullName, NamespaceParts @namespace, string type, string? alias = null)
    {
        ...
        Alias = alias ?? (type.EndsWith("Attribute", StringComparison.Ordinal)
...
#pragma warning restore CA1062 // Validate arguments of public methods
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj switch
        {
            QualifiedType t => Equals(t),
            ITypeSymbol t => Equals(t),
            TypeSyntax t => Equals(t),
            BaseTypeSyntax t => Equals(t),
            _ => false,
        };
    }
...
#pragma warning restore CA1062 // Validate arguments of public methods
    ...
    protected virtual bool Equals(ITypeSymbol? type)
    {
        ...
        return NameEquals(type.MetadataName) &&
               type.ContainingNamespace == Namespace;
    }
    ...
    protected virtual bool Equals(TypeSyntax? type)
    {
        ...
        return type switch
        {
            PredefinedTypeSyntax { Keyword: { } keyword } => keyword.ValueText == Alias,
            ...
            GenericNameSyntax genericName => Type.IsParts(genericName.Identifier.ValueText, "`", genericName.Arity.ToString(CultureInfo.InvariantCulture)),
            SimpleNameSyntax simple => NameEquals(simple.Identifier.ValueText) ||
                                       Aliased(simple),
            QualifiedNameSyntax qualified => Equals(qualified.Right) &&
                       Namespace.Matches(qualified.Left),
    ...
    /// <returns>True if equal.</returns>
    protected virtual bool Equals(BaseTypeSyntax? baseType) => Equals(baseType?.Type);
