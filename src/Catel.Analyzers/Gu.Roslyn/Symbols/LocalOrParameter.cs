...
#pragma warning restore RS0016 // Add public types and members to the declared API
{
    ...
    /// Gets the type.
    /// </summary>
    public ITypeSymbol Type => (Symbol as ILocalSymbol)?.Type ??
                               ((IParameterSymbol)Symbol).Type;
    ...
    public string Name => (Symbol as ILocalSymbol)?.Name ?? ((IParameterSymbol)Symbol).Name;
    ...
    /// <inheritdoc/>
    public bool Equals(LocalOrParameter other) => Symbol switch
    {
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is LocalOrParameter other && Equals(other);
