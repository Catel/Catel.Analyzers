...
public sealed class UsagesWalker : PooledWalker<UsagesWalker>
{
    ...
    /// </summary>
    public IReadOnlyList<IdentifierNameSyntax> Usages => usages;
    ...
    public override void VisitIdentifierName(IdentifierNameSyntax node)
    {
        ...
        bool IsMatch()
        {
            return node is { } &&
                   NameMatches() &&
                   semanticModel.TryGetSymbol(node, cancellationToken, out var nodeSymbol) &&
                   nodeSymbol.IsEquivalentTo(symbol);
            ...
            bool NameMatches()
            {
                ...
                {
                    return node.Identifier.ValueText.IsParts("@", symbol.Name);
                }

                return node.Identifier.ValueText == symbol.Name;
            }
        }
    }
