...
public sealed class IdentifierTokenWalker : PooledWalker<IdentifierTokenWalker>
{
    ...
    /// </summary>
    public IReadOnlyList<SyntaxToken> IdentifierTokens => identifierTokens;
    ...
    {
        foreach (var candidate in IdentifierTokens)
        {
    ...
    public void RemoveAll(Predicate<SyntaxToken> match) => identifierTokens.RemoveAll(match);
