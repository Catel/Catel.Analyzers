...
public sealed class VariableDeclaratorWalker : PooledWalker<VariableDeclaratorWalker>
{
    ...
    /// </summary>
    public IReadOnlyList<VariableDeclaratorSyntax> VariableDeclarators => variableDeclarators;
    ...
    public void RemoveAll(Predicate<VariableDeclaratorSyntax> match) => variableDeclarators.RemoveAll(match);
