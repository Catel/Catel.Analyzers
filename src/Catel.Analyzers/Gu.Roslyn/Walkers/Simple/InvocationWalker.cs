...
public sealed class InvocationWalker : PooledWalker<InvocationWalker>
{
    ...
    /// </summary>
    public IReadOnlyList<InvocationExpressionSyntax> Invocations => invocations;
    ...
    public void RemoveAll(Predicate<InvocationExpressionSyntax> match) => invocations.RemoveAll(match);
