...
public sealed class ThrowWalker : PooledWalker<ThrowWalker>
{
    ...
    /// </summary>
    public IReadOnlyList<SyntaxNode> ThrowStatementsAndExpressions => throwStatementsAndExpressions;
    ...
    {
        throwStatementsAndExpressions.Add(node);
    ...
    {
        throwStatementsAndExpressions.Clear();
    }
}
